...
#define CUSTOM_MACHINE_NAME "3D BEAST"
...
#define HOTEND_OFFSET_X {0.0, 18.0} // (mm) relative X-offset for each nozzle
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Micro-Swiss All Metal Hotend - 210 C
  #define DEFAULT_Kp 39.85
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 442.48, 442.48 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 100, 100 }
